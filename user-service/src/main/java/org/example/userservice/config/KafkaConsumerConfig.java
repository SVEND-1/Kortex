...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, UserRegisterEvent> consumerFactory(
        ...
        JsonDeserializer<UserRegisterEvent> jsonDeserializer =
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, UserRegisterEvent> kafkaListenerContainerFactory(
